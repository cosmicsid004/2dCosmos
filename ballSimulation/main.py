...
bg_image = pygame.image.load('ballSimulation/background.jpeg').convert()
ball_image = pygame.image.load('ballSimulation/ball.png').convert_alpha()
...
while running:
    ...
    # pygame.draw.line(game_display, (0, 0, 0), (ball.x, ball.y), (ball.x + 100, ball.y + 400), 5)
